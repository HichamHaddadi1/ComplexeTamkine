...
{{--    <!-- end section -->--}}
    ...
    <section class="layout_padding section auth_section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text_align_center">
                    <div class="text-center">
                        <a href="{{ route('front.home') }}"><img src="{{ asset('front/images/orientation-tamkine-100x100.png') }}" width="100" height="70" class="rounded" alt="orientation tamkine"></a>
                    </div>
                    <div class="full">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="contact_section w-50 mx-auto mt-5 " style="margin-bottom: 25%;">
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                <div class="form_cont">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <p class="loginhere">
                                            Vous n'avez pas de compte ? <a href="{{ route('register') }}" class="loginhere-link">S'inscrire</a>
                                        </p>
                                    </form>
                                </div>
                            </div>
