...
@section('content')
  ...
  <br>
    <div class="container col-md-10">
        <h3 class="text-center">Profil <i class="fas fa-user-alt"></i></h3> <br>
        <div class="card card-primary " id="card-participant">
         ...
         <div class="card-body">
            <table class="tab_info_pro">
                ...
                <td colspan="2" class="actions-salle">
                    <br>
                    <button type="button" class="btn-participant btn btn-info form-control float-right" data-toggle="modal" data-target=".bd-example-modal-lg" onclick="$('.succes').css('display','none');">Modifier &nbsp;<i class="fas fa-edit"></i></button>
                </td>
            </table>
         </div>
         <!-- /.card-body -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="" id="frmReg">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="inputEmail" class="form-control" name="pwd">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="inputRegions">Regions</label>
        ...
        <div class="modal-footer">
          <button type="button" class="btn-participant" data-dismiss="modal">Fermer</button>
          <button type="button" class="btn-participant" id="btn-mpo" data-id="{{$usr->id}}">Modifier</button>
        </div>
      </div>
  </div>
