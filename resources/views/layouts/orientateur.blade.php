...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" id="sidebar-orientateur">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item" @if(Auth::user()->role == "intervenant") style="display: none;" @else style="display: block;" @endif>
                <a href="{{route('orientateur.salle')}}" class="nav-link">
            ...
            <li class="nav-item" @if(isset(Auth::user()->salle->id) && Auth::user()->salle->id == 1) style="display: none;" @else style="display: block;" @endif>
                <a href="{{ route('orientateur.salle.pleniere') }}" class="nav-link">
