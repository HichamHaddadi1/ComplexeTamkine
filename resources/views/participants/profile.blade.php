         ...
         <div class="card-body">
            <table class="tab_info_pro">
                ...
                <tr>
                    ...
                    <td class="col-right" id="nom">{{ucfirst($usr->nom)}}</td>
                </tr>
                <!-- Prenom -->
                <tr>
                    <td class="col-left">Prénom:</td>
                    <td class="col-right" id="prenom">{{ucfirst($usr->prenom)}}</td>
                </tr>
                <!-- email -->
                <tr>
                ...
                <td colspan="2" class="actions-salle">
                    <br>
                    <button type="button" class="btn-participant" data-toggle="modal" data-target=".bd-example-modal-lg" onclick="$('.succes').css('display','none');">Modifier mon profil &nbsp;<i class="fas fa-edit"></i></button>
                </td>
            </table>
         </div>
         <!-- /.card-body -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="succes" style="display: none"> Votre profil a été modifié avec succès ! </div>
