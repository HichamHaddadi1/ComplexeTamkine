         ...
         <div class="card-body">
            <table class="tab_info_pro">
                ...
                <td colspan="2" class="actions-salle">
                    <br>
                    <button type="button" class="btn-imp" id="btn-dso"><a href="{{route('orientateur.rejoindre.salle.pleniere',['id'=> $salle->id])}}">Rejoindre la salle &nbsp;<i class="fas fa-play"></i></a></button>
                </td>
            </table>
         </div>
         <!-- /.card-body -->
