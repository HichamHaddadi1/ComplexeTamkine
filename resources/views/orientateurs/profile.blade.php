         ...
         <div class="card-body">
            <table class="tab_info_pro">
                ...
                <td colspan="2" class="actions-salle">
                    <br>
                    <button type="button" class="btn-imp" data-toggle="modal" data-target=".bd-example-modal-lg" onclick="$('.succes').css('display','none');">Modifier mon profil &nbsp;<i class="fas fa-edit"></i></button>
                </td>
            </table>
         </div>
         <!-- /.card-body -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn-imp" id="btn-mpo" data-id="{{$usr->id}}">Modifier</button>
        </div>
      </div>
  </div>
</div>
